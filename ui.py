...
class UI():
    ...
    def draw_reward_breakdown(self, reward_breakdown_1, reward_breakdown_2):
        g.framework.draw_dict_reward(reward_breakdown_1, "reward_breakdown", (650, c.settings["field_height"] - 50), REWARD_BREAKDOWN_FONT_SIZE)
        g.framework.draw_dict_reward(reward_breakdown_2, "reward_breakdown", (c.settings["field_width"] - 100, c.settings["field_height"] - 50), REWARD_BREAKDOWN_FONT_SIZE)

    def draw_observation(self, observation):
        g.framework.draw_dict_obs(observation, "reward_breakdown", (1100, 1700), REWARD_BREAKDOWN_FONT_SIZE)
