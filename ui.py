...
REWARD_POS = (20, 10)
SCORE_POS = (180, 45)
TIME_POS = (c.settings['field_width']/2, 55)
...
class UI():
    ...
    def draw_steps_left(self, steps_left):
        ...
        g.framework.draw_text(text, 'steps_left', TEXT_COLOR, STEPS_LEFT_POS, centered=True)
    ...
    def draw_score(self, score, paddle1, paddle2):
        ...
        g.framework.draw_text(text1, 'score', TEXT_COLOR, pos1, centered=True)
        g.framework.draw_text(text2, 'score', TEXT_COLOR, pos2, centered=True)
    ...
    def draw_time_left(self, time_left):
        g.framework.draw_text(str(time_left), 'time_left', TEXT_COLOR, TIME_POS, centered=True)
